...
struct pm25_message pm25_en_message_template[PM25_LEVEL_SIZE] = {
...
struct pm25_message pm25_zhtw_message_template[PM25_LEVEL_SIZE] = {
...
void loop() {
  ...
  if (need_publish_on_feed(pm25)) {
    ...
    char *pm25msg_part1 = pm25_en_message_template[pm25level].msg_part1;
    char *pm25msg_part2 = pm25_en_message_template[pm25level].msg_part2;
