/**
 ...
 The options are different depends on your environment.
 This source is compiled under linux with openssl source code.
 It is executed and verified under windows.
