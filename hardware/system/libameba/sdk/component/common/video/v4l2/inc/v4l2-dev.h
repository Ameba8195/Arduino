...
/* 
enum v4l2_priority { 
    V4L2_PRIORITY_UNSET       = 0,  // ?¢Gaicl?A 
    V4L2_PRIORITY_BACKGROUND  = 1,  // -I¡¦o 
    V4L2_PRIORITY_INTERACTIVE = 2,  // ??¢XE 
    V4L2_PRIORITY_RECORD      = 3,  // ?o?y
    V4L2_PRIORITY_DEFAULT     = V4L2_PRIORITY_INTERACTIVE, 
}; 
E?¢DyAv?O?¢X?FMultiple Opens?T¡±@!A¡Pi¢Di¢DH?a?udevice|PRE3Q|h-Othread ¢D¡¦?}(i.e open())
?Y-n¢DI3oAu¢DyAv¢Dh¢XI?A-t-O?T¡±@¡±o-?-n!A¡LI¢DIao¡Lo-OAu¢Dy¡ÂA¡±O!Aaoprios[4]¡¦N¢D[?@!C
*/ 
